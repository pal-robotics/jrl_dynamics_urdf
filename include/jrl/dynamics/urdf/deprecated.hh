...
#ifndef JRL_DYNAMICS_URDF_DEPRECATED_HH
# define JRL_DYNAMICS_URDF_DEPRECATED_HH
...
//  void foo () JRL_DYNAMICS_URDF_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar JRL_DYNAMICS_URDF_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a JRL_DYNAMICS_URDF_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define JRL_DYNAMICS_URDF_DEPRECATED __attribute__ ((deprecated))
# else
#  ifdef _MSC_VER
#   define JRL_DYNAMICS_URDF_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define JRL_DYNAMICS_URDF_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! JRL_DYNAMICS_URDF_DEPRECATED_HH
